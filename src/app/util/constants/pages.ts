...
export const paths = Object.freeze({
  ...
  presetTaskItems: `/${Pages.Profiles}/${Pages.PresetTaskItems}`,
  presetTaskItemsCreate: `/${Pages.Profiles}/${Pages.PresetTaskItems}/${PageStates.Create}`,
  presetTaskItemsDetails: `/${Pages.Profiles}/${Pages.PresetTaskItems}/${PageStates.Details}`,
  users: `/${Pages.Users}`,
